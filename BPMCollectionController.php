...
class BPMCollectionsController extends Controller
{    
    /*
     * AUTHENTIFICATION: Création du cookie de connexion
     */
    public function __construct() {
        $target_url = 'https://URLTOBPM/ServiceModel/AuthService.svc/Login';
    ...
    public function WSPOSTBPM($collection, $Id='', $tabObject) {
        ...
        $target_url = "https://URLTOBPM/0/ServiceModel/EntityDataService.svc/".$collection."/";
